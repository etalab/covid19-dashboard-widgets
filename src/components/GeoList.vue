<template>
  ...
  <div class="fr-mb-4w fr-mt-3v fr-mt-md-0">
    <div class="fr-mb-3w">
      ...
      <select class="fr-select fr-text--sm fr-mb-0 fr-py-1v" :class="selectedGeoLevel=='regions'?'selected':''" id="select-reg" name="select" @change="changeGeoLevel('regions',$event)">
    ...
    <div class="fr-mb-3w">
      ...
      <select class="fr-select fr-text--sm fr-mb-0 fr-py-1v" :class="selectedGeoLevel=='departements'?'selected':''" id="select-dep" name="select" @change="changeGeoLevel('departements',$event)">
