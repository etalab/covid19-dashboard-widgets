<template>
  ...
  <div class="data_box fr-p-3w" :data-display="display" :id="widgetId" v-bind:class="{'green':isGreen,'red':isRed, 'blue':isBlue,'loading':loading}">
    ...
    <div class="evol_box fr-text--sm fr-text--bold fr-py-1v fr-px-1w fr-mt-1w fr-mb-0" :evolcode="evolcode" :evolvalue="evolvalue" v-bind:class="{'down':isDown,'green':isGreen,'red':isRed,'blue':isBlue}">
