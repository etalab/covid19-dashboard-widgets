    ...
    <div data-box="loc">
      ...
      <p class="flex fr-text--sm fr-text--bold fr-my-0">
        <svg width="16" height="16" viewBox="0 0 16 16">
          <path
              d="M12.243 2.424c2.343 2.343 2.343 6.142 0 8.485L8 15.152l-4.243-4.243c-2.343-2.343-2.343-6.142 0-8.485C6.101.081 9.9.081 12.243 2.424zM4.7 3.367c-1.822 1.822-1.822 4.777 0 6.6l3.3 3.3 3.3-3.3c1.822-1.823 1.822-4.778 0-6.6-1.823-1.822-4.777-1.822-6.6 0zM8 5.333c.736 0 1.333.597 1.333 1.334C9.333 7.403 8.736 8 8 8s-1.333-.597-1.333-1.333c0-.737.597-1.334 1.333-1.334z"
              transform="translate(-550 -5417) translate(527 5237) translate(0 124) translate(23 56)"/>
        </svg>
          ...
          <p class="l_box_trend flex fr-text--xs fr-text--bold fr-px-1w fr-py-1v fr-mb-0"
            ...
            <svg class="trend_ico" width="16" height="16" viewBox="0 0 24 24">
              <path v-if="!isBlue[i]"
                    ...
                    transform="translate(-902 -5664) translate(902 5664)"/>
              <path v-if="isBlue[i]"
            ...
            <span class="fr-ml-1v">{{ convertFloatToHuman(evolvalues[i]) }} % en 7 jours</span>
          </p>
        </div>
      </div>
    </div>
